...
class Recipe(object):
    ...
    def set_cooking_time(self, cooking_time):
        ...
        # update recipe difficulty each time cooking time is altered
    ...
    def add_ingredients(self, *args):
        ...
        # update recipe difficulty each time ingredient is added
        self.difficluty = self.calculate_difficulty()
    ...
    # set class variable to store list of all ingredients across all objects
    all_ingredients = []
